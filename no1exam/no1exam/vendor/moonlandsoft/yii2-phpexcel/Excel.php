...
class Excel extends \yii\base\Widget
{
        ...
        foreach ($models as $model) {
            ...
            foreach ($columns as $key => $column) {
                ...
                if (is_array($column)) {
                    ...
                    $column_value = $this->executeGetColumnData($model, [
                        'attribute' => $column
                    ]);
                }
    ...
    /**
     * Populating columns for checking the column is string or array.
     * if is string this will be checking have a formatter or header.
     *
     * @param array $columns
